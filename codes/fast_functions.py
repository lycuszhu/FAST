...
class fast:
    ...
    def __init__(
        self,
        *,
        include_max_feature: bool = False,          # add 5th stat 'max' (applies to kernels and shapelets)
        additional_kernel_families: bool = True,    # include K=6/K=3 in addition to K=9
        kernel_budget_total: Optional[int] = None,  # columns; None => 50k (K9) or 60k (K369); ×1.25 if include_max_feature
        ...
        keep_best_dilation_only: bool = False,
        # LDS
        ...
        if kernel_budget_total is None:
            ...
            if self.include_max_feature:
                base = int(round(base * 1.25))   # +25% if we also add 'max'
        ...
        self.keep_best_dilation_only = bool(keep_best_dilation_only)  # ignored in utils.harvest_shapelets
    ...
    def assemble_features(
        ...
        # Defaults in case no shapelets requested
        ...
        if want_shapelets:
            kept = harvest_shapelets(
                ...
                shapelet_bias_mode=self.shapelet_bias_mode,
                ...
                keep_best_dilation_only=self.keep_best_dilation_only,  # ignored
